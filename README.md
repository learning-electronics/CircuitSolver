...
* To get the of the voltage of component `C1`: `python3 mytopcaller.py examples/example2_AC.cir 1 1 question1 0 C1 400 V`.
* To get the resolution of the nodal analysis: `python3 mytopcaller.py examples/example2_AC.cir 1 1 question1 0 C1 400`.
